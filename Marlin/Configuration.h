...
#define STRING_CONFIG_H_AUTHOR "(SusisStrolch, Vertex Delta K8800)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #if ENABLED(E3D_HOTEND)
      // Vertex Delta (E3D cooper block, 40W, 5C@220°C)
      // Kp: 14.7925 Ki: 1.3085 Kd: 41.8072
      // Vertex Delta (E3D cooper block, 40W, 5C@220°C, silicon sock)
      // Kp: 15.4785 Ki: 1.3496 Kd: 44.3807
      // Vertex Delta (E3D cooper block, 40W, 5C@200°C, silicon sock)
      // Kp: 16.6569 Ki: 1.4628 Kd: 47.4182
      #define DEFAULT_Kp 16.6569
      #define DEFAULT_Ki 1.4628
      #define DEFAULT_Kd 47.4182
    #else
      // Stock Vertex Delta Hotend
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from pid autotune. "M303 E-1 C8 S60" to run autotune on the bed at 60 degreesC for 8 cycles
	...
	#define DEFAULT_bedKp 114.8573
	#define DEFAULT_bedKi 21.9068
	#define DEFAULT_bedKd 401.4645
  #else
...
#define DELTA
  ...
  #define STOCK_K8800_DELTAHEIGHT	308.0 // (mm) Get this value from G33 auto calibrate
    ...
    //  #define DELTA_DIAGONAL_ROD 288.13   	// (mm) Haydn Huntley MagArms
      #define DELTA_DIAGONAL_ROD ( 288.13 *  0.9865 )  	// (mm) Haydn Huntley MagArms - XY compensation
...
>>>>>>> 82540be931940651f247e011071c1f18c0b96ed0
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 9000, 9000, 9000, 15000 }

//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 12000, 12000, 12000, 20000 } // ...or, set your own edit limits
#endif
...
#else
  #define DEFAULT_ACCELERATION          (9000 / 2)    // X, Y, Z and E acceleration for printing moves
  #define DEFAULT_RETRACT_ACCELERATION  (15000 / 2)    // E acceleration for retracts
  #define DEFAULT_TRAVEL_ACCELERATION   (9000 / 2)    // X, Y, Z acceleration for travel (non printing) moves
#endif
...
#else
  #define Z_PROBE_SPEED_FAST (2 * XY_PROBE_SPEED)
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE (25 * 60)  // (mm/s) X and Y axes feedrate (also used for delta Z axis)
  #define NOZZLE_PARK_Z_FEEDRATE  (25 * 60)  // (mm/s) Z axis feedrate (not used for delta printers)
#endif
